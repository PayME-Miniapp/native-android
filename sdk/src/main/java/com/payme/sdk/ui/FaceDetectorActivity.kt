...
class FaceDetectorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hint1 = intent.getStringExtra("hint1")
        val hint2 = intent.getStringExtra("hint2")
        val hint3 = intent.getStringExtra("hint3")
            ...
            runOnUiThread {
                if (it.isEmpty()) {
                    ...
                    if (faceDetectorStepViewModel.getStep().value == 2) {
                        textHint.text = (hint2 ?: getString(R.string.face_detector_hint2))
                    }
                    if (faceDetectorStepViewModel.getStep().value == 3) {
                        textHint.text = (hint3 ?: getString(R.string.face_detector_hint3))
                    }
                } else {
                    textHint.text = it
                }
